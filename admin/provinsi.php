          ...
          <div id="loginbox" style="margin-top: ;" class="mainbox col-md-12">
            ...
            <?php if (isset($_GET['msg'])): ?>
              ...
              <div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> Data Provinsi berhasil di Hapus!</h4>
              </div>            
              <?php endif ?>
            <?php endif ?>
            <!-- /.alert -->
              ...
              <div style="padding-top: 10px" class="panel-body">
                ...
                <?php
                 if (isset($_POST['btn-save'])) {
                   ...
                   if ($siswa->create_provinsi($province_name,$status,$created_userid)) {
                     echo "<script> alert('Provinsi Berhasi Di Tambah') </script>";
                     echo "<meta http-equiv='refresh' content='0; url=?menu=provinsi'>";
                   }
